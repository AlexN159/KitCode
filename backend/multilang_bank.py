...
def _sql() -> list[dict]:
    ...
    for family_index,(slug,base_title,description,solution,topics,complexity,setup,expected) in enumerate(families,1):
        for variant,suffix in enumerate(suffixes,1):
            ...
            else: extra=[("CREATE TABLE staff(name TEXT,team TEXT); INSERT INTO staff VALUES('A','A'),('B','A');","A"),("CREATE TABLE staff(name TEXT,team TEXT); INSERT INTO staff VALUES('A','A');",""),("CREATE TABLE staff(name TEXT,team TEXT); INSERT INTO staff VALUES('A','Z'),('B','A'),('C','A'),('D','Z'),('E','A');","A\nZ"),("CREATE TABLE staff(name TEXT,team TEXT);","" )]
